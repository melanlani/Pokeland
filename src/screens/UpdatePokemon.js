...
import { getTypes, updatePokemon, detailPoke } from '../redux/actions/pokemons';
class UpdatePokemon extends Component {
  ...
  savePokemon = () => {
    ...
    const id = this.props.navigation.getParam('id', '');
    this.props.updatePokemonDispatch(this.state.category, this.state.selectedItems, this.state.name_poke, this.state.image_poke, this.state.latitude, this.state.longitude,id)
      Toast.show({
        ...
        renderItem={({item}) =>(
          <Card>
            <CardItem header bordered>
              <Text style={styles.txtsubtitle}>Update Pokemon</Text>
            </CardItem>
            ...
            <CardItem>
              <Form style={{width:320, backgroundColor:'#c5d3e8'}}>
                ...
                >
                  <Picker.Item label="Dragon" value="1" disable/>
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    updatePokemonDispatch: (category, selectedItems, name_poke, image_poke, latitude, longitude,id) => {
      dispatch(updatePokemon(category, selectedItems, name_poke, image_poke, latitude, longitude,id))
    },
